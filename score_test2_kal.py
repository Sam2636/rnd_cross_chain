...
for document in slug_db.list_collection_names():
    ...
    if(document=="klay-ape-club"):
        ...
        total_nfts=10000 #len(list(slug_db[document].find({})))
        print(total_nfts)
        ...
        for fir in list(slug_db[document].find({})):
            if fir['traits']=="None":
                nonerdict.append(fir)
            else:
                all.append(fir)
            ...
            for ioi in main_poet:                
                ...
                for pogg in list(dictsmain.keys()):
                    if pogg.lower()==ioi['name'].lower():
                        ...
                        if ggez=="background founder":
                            ggez="background_founder"
