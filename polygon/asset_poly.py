...
mycol = my_db['poly_slug']
infoz=mycol.find({})
#mycol2 = my_db.collection_stats_by_raritytools
#mycol3= my_db["nftgdp_coll_details"]
#info=my_db.avalanch_e_slug
my_db_2=client['poly_nfttrade_asset']
...
contract_add=hj[1]
print(contract_add)
name="Poly+punks"#ni[0].replace(" ","+")
print(name)
contract_ID=jp[1]  #------>change according to the collection
print(contract_ID) #------>change according to the collection
info=my_db_2['polygonpunks']
while True:
    #print(jk,"ewfafwef")
    # 6969 
    print("justkidding",jk)
    try:
        ap=api_1("https://api.nftrade.com/api/v1/tokens?limit=30&skip={}&search={}".format(jk,name))
        print(ap)
        #ap=api_1("https://api.nftrade.com/api/v1/tokens?limit=30&skip={}&contracts[]={}&chains[]=43114".format(jk,contract_ID))
        #https://nftrade.com/_next/data/2ogRZydkZ4eA_SP433X2d/assets/polygon/0xce9d0f73265c7867254e8ff445ab640674d95d23.json?chainName=polygon&contractAddress=0xce9d0f73265c7867254e8ff445ab640674d95d23
    except:
        time.sleep(3)
        print('case1')
        ap=api_1("https://api.nftrade.com/api/v1/tokens?limit=30&skip={}&search={}".format(jk,name))
    ...
    for i in ap:
        ...
        j=j+1
        try:
            ap2=api_1("https://nftrade.com/_next/data/{}/assets/polygon/{}/{}.json".format(key1,contract_add,pl))
        except:
            time.sleep(2)
            print("case2")
            ap2=api_1("https://nftrade.com/_next/data/{}/assets/polygon/{}/{}.json".format(key1,contract_add,pl))
        ...
        try:
            ...
            li='None'   
            dictsmain='None' 
        permalink="https://nftrade.com/assets/polygon/{}/{}".format(contract_add,pl)
